...
const NeutralComments = ({ report, onBack, isGeneratedReport = false }) => {
  ...
  // Set initial filter for neutral comments
  useEffect(() => {
    updateFilters({ commentType: "neutral" });
  }, [updateFilters]);
        ...
        <div className="container mx-auto py-8">
          ...
          <div className="bg-white shadow-lg rounded-lg">
            ...
            <main className="p-8">
              ...
              <h4 className="text-xl font-bold mb-2">Neutral Comments</h4>
              <p className="text-sm text-gray-600 mb-6">Total Neutral Comments: {commentsPagination.total}</p>
              ...
              {loading ? (
                ...
                <div className="text-center py-12 text-gray-500">
                  <p>No neutral comments found for this report.</p>
                </div>
              ) : (
                <>
                  <div className="space-y-4">
                    {commentsData.map((comment, index) => (
                      <div key={comment.id || index} className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg">
