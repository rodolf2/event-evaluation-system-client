    ...
    <div className="bg-white border-2 border-gray-200 hover:border-blue-400 hover:shadow-xl rounded-lg overflow-hidden p-3 sm:p-4 transition-all duration-200 flex flex-col h-full shadow-md">
      <div className="relative aspect-video w-full rounded-lg overflow-hidden group">
        ...
        {report.thumbnail ? (
          <div className="w-full h-full relative">
            ...
            >
              ...
              <div className="text-white text-center">
                ...
                <p className="text-xs font-medium line-clamp-2 px-2">
                  {report.title}
                </p>
              </div>
            </div>
          ...
          <div
            className={`w-full h-full bg-linear-to-br ${getGradientColor(report.title)} flex flex-col items-center justify-center p-4`}
          >
            <div className="bg-white/20 rounded-full p-3 mb-2">
              <BarChart2 className="w-8 h-8 text-white" />
            </div>
      ...
      <div className="flex-1 flex flex-col justify-center mt-3">
        ...
        {report.sharedBy && (
          <p className="text-[10px] sm:text-xs text-gray-500 text-center mt-1 flex items-center justify-center gap-1">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 mb-6">
            ...
            <div className="flex flex-wrap items-center justify-between lg:justify-start gap-4 w-full lg:w-auto lg:ml-auto">
              <div className="relative min-w-[140px]">
                <div className="flex items-center bg-white border border-gray-100 rounded-lg px-3 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 shadow-sm">
